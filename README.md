...
[![PDF.js](https://img.shields.io/badge/PDF.js-4.10-FF3621?style=for-the-badge&logo=adobeacrobatreader&logoColor=white)](https://mozilla.github.io/pdf.js/)
[![Framer Motion](https://img.shields.io/badge/Framer_Motion-12.4-0055FF?style=for-the-badge&logo=framer&logoColor=white)](https://framer.com/motion)
[![Supabase](https://img.shields.io/badge/Supabase-Database-3ECF8E?style=for-the-badge&logo=supabase&logoColor=white)](https://supabase.com/)
[![Google Analytics](https://img.shields.io/badge/Google_Analytics-GA4-E37400?style=for-the-badge&logo=googleanalytics&logoColor=white)](https://analytics.google.com/)
[![PWA Ready](https://img.shields.io/badge/PWA-Supported-5A0FC8?style=for-the-badge&logo=pwa&logoColor=white)](#-1-المميزات-الرئيسية-للمنصة-key-features)
[![Vercel](https://img.shields.io/badge/Vercel-Deployed-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://al-raheq-al-makhtom.vercel.app)
[![Lighthouse Performance](https://img.shields.io/badge/Lighthouse-98%2F100-4CAF50?style=for-the-badge&logo=lighthouse&logoColor=white)](#-5-مؤشرات-الأداء-والجودة-benchmarks)
[![Accessibility](https://img.shields.io/badge/Accessibility-100%25-009688?style=for-the-badge&logo=w3c&logoColor=white)](#-5-مؤشرات-الأداء-والجودة-benchmarks)
...
sequenceDiagram
    autonumber
    actor User as القارئ / الزائر
    participant App as واجهة التطبيق (React 19)
    participant Store as إدارة الحالة (Zustand)
    participant Telemetry as محرك التتبع والتحليلات
    participant Cloud as قاعدة البيانات (Supabase)

    User->>App: فتح المنصة أو قراءة صفحة في الكتاب
    App->>Store: تحديث رقم الصفحة وتراكم نقاط XP
    
    par التخزين المحلي والسحابي
        Store->>Cloud: مزامنة التقدم السحابي (Async Progress Sync)
    and التتبع وتأخير السكربتات (requestIdleCallback)
        App->>Telemetry: إرسال أحداث GA4 وتنبيه الزيارة إلى Telegram
    end

    alt فتح وسام جديد أو إكمال الفصل
        App->>User: تشغيل مؤثرات الاحتفال (Confetti) وإظهار نافذة الإنجاز
    end
```
...
```mermaid
graph TD
    Root[⚡ App Entry: index.js] --> Reader[📖 ReaderView - Lazy]
    Root --> Quiz[🎯 QuizArenaView - Lazy]
    Root --> Mistakes[🧠 MistakesBankView - Lazy]
    Root --> Analytics[📊 AnalyticsView - Lazy]

    Root --> ChunkPDF[📦 vendor-pdfjs: PDF.js Core Engine]
    Root --> ChunkCharts[📈 vendor-charts: Recharts & D3 Scale]
    Root --> ChunkMotion[✨ vendor-motion: Framer Motion Engine]
    Root --> ChunkIcons[🎨 vendor-icons: Lucide React Suite]
    Root --> ChunkUtils[📷 vendor-utils: html-to-image & Confetti]
    Root --> ChunkCore[⚙️ vendor-core: React 19 + Zustand + Utilities]
```
...
[![GitHub](https://img.shields.io/badge/GitHub-MikeeeDeV-181717?style=for-the-badge&logo=github)](https://github.com/MikeeeDeV)
[![Live Demo](https://img.shields.io/badge/Live_App-الرحيق_المختوم-000000?style=for-the-badge&logo=vercel)](https://al-raheq-al-makhtom.vercel.app)
