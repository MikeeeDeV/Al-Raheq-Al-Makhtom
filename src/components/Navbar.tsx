...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      {/* Top Header Bar - Next-Gen Glassmorphic Header */}
      <header className="sticky top-0 z-40 bg-white/80 dark:bg-slate-950/80 backdrop-blur-2xl border-b border-slate-200/60 dark:border-slate-800/60 transition-all shadow-xs font-arabic dir-rtl">
        {/* Subtle Top Ambient Glow Accent */}
        <div className="h-[2px] w-full bg-gradient-to-r from-emerald-500/0 via-emerald-500/70 to-teal-500/0" />
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-2 sm:gap-4">
          ...
          >
            <div className="relative">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-tr from-emerald-700 via-teal-600 to-emerald-500 text-white flex items-center justify-center shadow-lg shadow-emerald-600/25 group-hover:shadow-emerald-500/40 transition-all border border-emerald-400/40">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <span className="px-1.5 py-0.2 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 rounded-md text-[9px] font-bold border border-emerald-500/20">
                  تفاعلي
                </span>
              </div>
          ...
          {/* Right Action Tools & Micro Badges */}
          <div className="flex items-center gap-1.5 sm:gap-2">
            {/* Streak Counter Glowing Pill */}
            <motion.div
              whileHover={{ scale: 1.05 }}
              className="flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 bg-gradient-to-r from-amber-500/15 via-orange-500/15 to-amber-500/15 text-amber-900 dark:text-amber-300 rounded-full border border-amber-500/30 text-xs font-black shrink-0 shadow-xs cursor-default"
            ...
            <motion.button
              ...
              className="p-2 sm:p-2.5 text-slate-600 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-500/10 rounded-full transition cursor-pointer"
